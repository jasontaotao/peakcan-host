...
PARENT_SHA = "d07cb77b7a30c89d22bb2be2b9b5d6f95f3aab8a"  # v3.16.8 hotfix (Directory.Build.props bump)
...
ADDED_OR_MODIFIED = [
    ...
    "src/PeakCan.Host.Core.Tests/Replay/ReplayTimelineTests.cs",
    "src/PeakCan.Host.Core.Tests/Replay/AscParserTests.cs",
    "src/Directory.Build.props",
    "src/PeakCan.Host.App.Tests/ViewModels/TraceViewerViewModelTests.cs",
    # Per-PATCH release notes (local-only, not in tier3 overlay)
    "docs/release-notes-v3.16.9.0.md",
    # Plan + spec + anchors (local-only)
    ...
    # Tier-3 ship scripts (local-only, for record)
    ...
    "docs/release-notes-v3.13.2.md",
    "docs/release-notes-v3.13.3.md",
    ...
    "docs/release-notes-v3.16.1.md",
    "docs/release-notes-v3.16.2.md",
    "docs/release-notes-v3.16.3.md",
    "docs/release-notes-v3.16.4.md",
    "docs/release-notes-v3.16.5.md",
    "docs/release-notes-v3.16.6.md",
    "docs/release-notes-v3.16.7.1.md",
    "docs/release-notes-v3.16.7.md",
    "docs/release-notes-v3.16.8.md",
]
