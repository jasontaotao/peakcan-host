"""W26 T2 deletion script — remove CallbackRegistry region (L106-184) from CanApi.cs.
...
W13 T1 2/3 loose-assertion: predicted -79 LoC (range L106-L184 inclusive = 79 lines),
...
print(f"Expected delta: 79 (Flow B CallbackRegistry 4 mutators range L106-L184). Within ±2 LoC tolerance.")
assert 77 <= delta <= 81, f"FAIL: delta {delta} outside ±2 tolerance"
print("PASS.")
