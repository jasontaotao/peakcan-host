...
| 13 Trace view        | complete | `e56b024` feat | 213/213 pass + 4 SKIP (Core 137 + Infrastructure 53 + App 23 — AppHostBuilderTests 8 + AppShellViewModelTests 4 active + 2 hardware SKIP + **11 new** TraceViewModelTests 4 + TraceServiceTests 5 + SinkWiringServiceTests 2); build 0 warn 0 err across 6 projects; **pending reviewer** |
...
6. Current test count: **213 pass + 4 SKIP** (Core 137 + Infrastructure 53 + App 23). Test project `tests/PeakCan.Host.App.Tests/` exists and targets `net10.0-windows` with `<UseWPF>true</UseWPF>` (required to instantiate WPF Window types in tests).
...
| 13 Trace              | complete | `e56b024` feat | 23/23 App tests pass (11 new); build 0 warn 0 err; reviewer pending |
| 14 Send               | pending | — | — |
