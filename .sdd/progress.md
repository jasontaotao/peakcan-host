...
| 13 Trace view        | complete | `<sha>` feat | 213/213 pass + 4 SKIP (Core 137 + Infrastructure 53 + App 23 — AppHostBuilderTests 8 + AppShellViewModelTests 4 active + 2 hardware SKIP + **11 new** TraceViewModelTests 4 + TraceServiceTests 5 + SinkWiringServiceTests 2); build 0 warn 0 err across 6 projects; **pending reviewer** |
...
| 13 Trace              | complete | `<sha>` feat | 23/23 App tests pass (11 new); build 0 warn 0 err; reviewer pending |
| 14 Send               | pending | — | — |
